...
# mount the .netrc file which should contain credentials required to access our Go modules in private repos
# assumes that the docker build command includes --secret id=netrc,src=/path/to/.netrc
# (this is already configured correctly in our CI build task)
